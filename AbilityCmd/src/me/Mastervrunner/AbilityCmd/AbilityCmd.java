 ...
 */
public class AbilityCmd extends FireAbility implements AddonAbility {
	...
	//..public String[] abilCMDS;
	//abilCMDSString.equals("")
	 ...
	 */
	public AbilityCmd(Player player) {
		super(player);
	...
	public String getDescription() {
		return "Yes, this is the description";
	}
	...
	public ArrayList<String> getAbilCMDs() {
		return abilCMDS;
	}
	...
	public void load() {
		 ...
		 */
		ProjectKorra.plugin.getServer().getPluginManager().registerEvents(new AbilityCmdListener(), ProjectKorra.plugin);
		
		ConfigManager.getConfig().addDefault("ExtraAbilities.Mastervrunner.AbCmd.comboCommands1", "minecraft:Kill @p - LEFT_CLICK_DIRT: SwiftKick | SHIFT_DOWN: RapidPunch | SHIFT_UP: Jab");//Ty0ped everythign manually lols that why there was typo
